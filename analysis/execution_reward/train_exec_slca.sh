#!/usr/bin/env bash
#
# Rebuttal Experiment D — SLCA-GRPO + Execution-Based Reward
...
# advantage estimator = slca_grpo (segment-locked routing)
#
...
# Output directory: execution-based reward, SLCA arm
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/analysis/execution_reward/slca_7b}"

# Reward function: execution-based reward (R_succ + S_summary)
...
echo "=========================================="
echo "Rebuttal Experiment D — SLCA-GRPO"
...
echo "  advantage = slca_grpo (segment-locked routing)"
echo ""
...
EXPERIMENT_NAME="exec_based_slca_7b"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

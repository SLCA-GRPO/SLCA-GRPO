#!/usr/bin/env bash
#
# Gradient cosine-similarity probe -- SLCA-GRPO
...
# Output directory: gradient cosine probe, SLCA (3B)
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/analysis/grad_cosine/slca_3b}"
...
# ============================================================================
# HierR weights -- Default (as reported in the paper)
# ============================================================================
...
EXPERIMENT_NAME="grad_cosine_slca_3b"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

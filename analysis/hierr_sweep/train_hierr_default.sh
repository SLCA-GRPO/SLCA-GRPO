#!/usr/bin/env bash
#
# HierR weight-sensitivity sweep -- Default configuration
# Weights: format=0.10, name=0.25, key=0.15, value=0.20, parallel=0.30
...
echo "=========================================="
echo "HierR weight sensitivity -- Default configuration"

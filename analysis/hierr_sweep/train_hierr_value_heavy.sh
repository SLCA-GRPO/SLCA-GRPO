#!/usr/bin/env bash
#
# HierR weight-sensitivity sweep -- Value-heavy configuration
# Weights: format=0.05, name=0.20, key=0.20, value=0.35, parallel=0.20
# Emphasises argument-value matching.
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/analysis/hierr_sweep/value_heavy}"

# Reward function shipped in this directory
REWARD_FN_PATH="${REWARD_FN_PATH:-${SCRIPT_DIR}/reward_fn_hierr_v82.py}"

# ============================================================================
# HierR weights -- Value-heavy
# ============================================================================
export SLCA_WEIGHT_PROCESS="${SLCA_WEIGHT_PROCESS:-1.0}"
export SLCA_WEIGHT_FORMAT="${SLCA_WEIGHT_FORMAT:-0.05}"
export SLCA_WEIGHT_NAME="${SLCA_WEIGHT_NAME:-0.20}"
export SLCA_WEIGHT_KEY="${SLCA_WEIGHT_KEY:-0.20}"
export SLCA_WEIGHT_VALUE="${SLCA_WEIGHT_VALUE:-0.35}"
export SLCA_WEIGHT_PARALLEL="${SLCA_WEIGHT_PARALLEL:-0.20}"
...
echo "=========================================="
echo "HierR weight sensitivity -- Value-heavy configuration"
...
EXPERIMENT_NAME="qwen2_5_7b_hierr_value_heavy"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

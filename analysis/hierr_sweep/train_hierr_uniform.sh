#!/usr/bin/env bash
#
# HierR weight-sensitivity sweep -- Uniform configuration
# Weights: format=0.20, name=0.20, key=0.20, value=0.20, parallel=0.20
...
echo "=========================================="
echo "HierR weight sensitivity -- Uniform configuration"
...
EXPERIMENT_NAME="qwen2_5_7b_hierr_uniform"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

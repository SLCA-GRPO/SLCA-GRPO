...
#
# Ablation (i): w/o SLCA
# Removes segment-locked credit routing; standard GRPO shares one advantage.
#
# ================================================================================
# What this ablation removes
# ================================================================================
# Full method: SLCA-GRPO
#   - advantages are computed separately for the process (tool-call) and summary segments
#   - each segment gets its own reward signal and credit assignment
#
# Ablated variant: standard GRPO
#   - the whole response shares a single advantage
#   - no segment-level credit assignment
#
# Key change:
#   algorithm.adv_estimator=grpo (slca_grpo in the full method)
#
# ================================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/ablations/wo_slca}"

# Reward function: same HierR reward as the full method, only the advantage estimator differs
...
echo "==========================================="
echo "Ablation (i): w/o SLCA"
echo "==========================================="
echo ""
echo "Key changes:"
echo "  - algorithm.adv_estimator=grpo (slca_grpo in the full method)"
echo "  - one advantage for the whole response; no segment-level credit"
echo ""
...
EXPERIMENT_NAME="ablation_wo_slca"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"
...
echo ""
echo "==========================================="
echo "Ablation (i) w/o SLCA finished."
echo "output dir : ${OUTPUT_DIR}"
echo "==========================================="

#!/usr/bin/env bash
#
# ToolPO-GRPO Baseline: Qwen2.5-7B
#
...
# Output directory
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/rl/qwen2_5_7b_toolpo}"
...
echo "=========================================="
echo "ToolPO-GRPO baseline training (Qwen2.5-7B)"
echo "=========================================="
echo ""
...
PROJECT_NAME="Toucan_baseline_toolpo_qwen2.5-7B-NEW"
EXPERIMENT_NAME="qwen2.5_7b_toolpo_lambda${TOOLPO_LAMBDA}-NEW"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

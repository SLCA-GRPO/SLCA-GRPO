#!/usr/bin/env bash
#
# ToolPO-GRPO Baseline: Qwen3-8B-Base
#
# ToolPO advantage composition (ToolPO paper Eq. 7):
...
#   - S_pref = 0 (no memory folding in this setting)
#   - keeps the Toucan LLM judge and the SLCA evaluation metrics for a like-for-like comparison
...
TRAIN_DATA="${TRAIN_DATA:-${DATA_DIR}/toucan_toolcall_rl_thinking.parquet}"

VAL_DATA_DIR="${VAL_DATA_DIR:-${REPO_ROOT}/data}"
VAL_DATA="${VAL_DATA:-${DATA_DIR}/toucan_eval_4k_unified_thinking.parquet}"

# Model path (Qwen3-8B-Base)
MODEL_PATH="${MODEL_PATH:-${REPO_ROOT}/outputs/sft_split/qwen3_8b_base_toucan_toolcall}"

# Output directory
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/rl/qwen3_8b_base_toolpo}"
...
# ============================================================================
# Weights: identical to the main SLCA runs
# ============================================================================
...
echo "=========================================="
echo "ToolPO-GRPO baseline training (Qwen3-8B-Base)"
echo "=========================================="
echo ""
echo "★ ToolPO: toolpo_grpo + vanilla loss"
...
PROJECT_NAME="Toucan_baseline_toolpo_qwen3-8B-Base-NEW"
EXPERIMENT_NAME="qwen3_8b_base_toolpo_lambda${TOOLPO_LAMBDA}-NEW"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"

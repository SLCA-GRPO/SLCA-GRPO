#!/usr/bin/env bash
#
# RLTR-2Stage Baseline: Qwen3-8B-Base (Planner Training)
#
...
MODEL_PATH="${MODEL_PATH:-${REPO_ROOT}/outputs/planner_sft/qwen3_8b_base_planner}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/rl/qwen3_8b_base_rltr_2stage}"
...
echo "=========================================="
echo "RLTR-2Stage baseline: planner training (Qwen3-8B-Base)"
echo "=========================================="
...
PROJECT_NAME="Toucan_baseline_rltr_qwen3-8B-Base-New"
EXPERIMENT_NAME="qwen3_8b_base_rltr_2stage-New"
N_GPUS_PER_NODE=8
NNODES="${NNODES:-4}"
